...
for i = 1:size(files,1)
    ...
    temp = temp{1,1}; filenames{i,1} = temp; % Create recordings IDs from filenames - DLC outputs end with _DLC...
end
...
writetable(vert,'Your-Directory\Pupil_Tracking_Results-NoZeros.xlsx','Sheet','Vertical_Distance');
writetable(horz,'Your-Directory\Pupil_Tracking_Results-NoZeros.xlsx','Sheet','Horizontal_Distance');
...
writetable(vert,'Your-Directory\Pupil_Tracking_Results-NoZeros-Smoothed.xlsx','Sheet','Vertical_Distance');
writetable(horz,'Your-Directory\Pupil_Tracking_Results-NoZeros-Smoothed.xlsx','Sheet','Horizontal_Distance');
